...
public class Encriptacion {
    ...
    public static String encrpyter(String word, String keyword,
        ...
        Encriptacion.keyword = keyword;
        if (abecedarium != null) {
            Encriptacion.abecedarium = abecedarium;
        } else {
            Encriptacion.abecedarium = ABECEDARIUM;
        }
        table = tableBuilder(word);
    ...
    public static void main(String[] args) {
        String keywordForExample = "12345";
        String wordBeingEncrypted = "MIGATOSEHAQUEDADODORMIDO";
        System.out.println("### Example of Columnar Transposition Cipher ###\n");
        System.out.println("Word being encryped ->>> " + wordBeingEncrypted);
        System.out.println("Word encrypted ->>> " + Encriptacion
                .encrpyter(wordBeingEncrypted, keywordForExample));
        System.out.println("Word decryped ->>> " + Encriptacion
                .decrypter());
        System.out.println("\n### Encrypted Table ###");
        showTable();
    }
